                        ...
                        <div class="row"> 
                            ...
                            <div class="col-md-8 text-center">
                                ...
                                @if ($smartcard == 'NO_CONNECT' )
                                    <img src="http://localhost:8189/assets/images/smartcard-connected.png" alt="" width="270px"><br> <br>
                                  ...
                                  @else
                                        ...
                                        <img src="{{ asset('images/card1.jpg') }}" alt="Image" class="img-thumbnail shadow-lg me-4" width="270px">
                                        <br><br>
